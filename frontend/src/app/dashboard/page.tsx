/**
 * HeatGuard Pro Live Monitoring Dashboard
 * Real-time workforce safety monitoring dashboard with backend integration
 */
                ...
                <div key={alert.id} className="flex items-start space-x-3 p-2 hover:bg-gray-50 rounded">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      ...
                      <span className="text-xs text-gray-500">Worker {alert.worker_id}</span>
                    </div>
                  </div>
                </div>
              ))}
